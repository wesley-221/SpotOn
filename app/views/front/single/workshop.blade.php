            ...
            <article class="panel content">
                ...
                <p class="clearfix">
                    @if($workshop->featured_image && $workshop->featured_visible)
                        <a title="Volledige grootte" class="side-image" target="_blank" href="/uploads/{{ $workshop->featured_image }}">
                            <img src="/uploads/{{ $workshop->featured_image }}" alt="Featured image" />
                        </a>
                    @endif
                    {{ $workshop->text }}
                </p>
